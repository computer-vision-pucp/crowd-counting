...
if __name__ == '__main__':
    ...
    elif args.dataset == "towncenter":
        dataset_paths = {'test': ['../dataset/towncenter/test_data/images',
                              '../dataset/towncenter/test_data/ground-truth'],
                         'train': ['../dataset/towncenter/train_data/images',
                               '../dataset/towncenter/train_data/ground-truth']}
        validation_set = 150
        output_downscale = 2
        path = '../dataset/towncenter_train'
